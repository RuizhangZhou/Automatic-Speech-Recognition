...
Lexicon::Lexicon(Bliss::LexiconRef lexicon, AcousticModelRef am)//what's Bliss?
...
const Am::Allophone *Lexicon::allophone(Word word,GITBliss::Phoneme::Id id) const {//Why I can't find Allophone in Am folder?
